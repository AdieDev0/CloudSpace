...
const ShopCo = () => {
  ...
  return (
    <div className='max-w-[1350px] w-full mx-auto py-4 px-4 relative mb-10'>
      <div>
        <motion.p
          className='font-Jost font-bold text-3xl sm:text-4xl text-[#272626] pb-4 pl-4'
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <motion.div
        ...
        className='relative w-full h-[300px] sm:h-[400px] lg:h-[650px] rounded-2xl bg-center bg-cover duration-500 mb-4'
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        {/* Left Arrow */}
        <motion.div
          className='absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-full group-hover:translate-x-0 transition-transform duration-300'
        ...
        {/* Right Arrow */}
        <motion.div
          className='absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-full group-hover:translate-x-0 transition-transform duration-300'
          initial={{ opacity: 0, x: 100 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5 }}
        >
